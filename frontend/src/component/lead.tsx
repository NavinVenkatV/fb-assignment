...
function Lead() {
    return (
        <div className="p-3 relative z-50 border border-neutral-200 rounded-xl w-[900px] h-[400px] bg-neutral-100">
            <div>
            ...
            <div className="mt-5">
                ...
                <div className="flex flex-wrap justify-between">
                    <LeadBox title="Leads from List(s)" desc="connect multiple list as source for this sequence." />
